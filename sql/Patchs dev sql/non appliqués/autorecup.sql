...
create table recup_server (id INT not null, name VARCHAR(256), realmlist VARCHAR(256) not null, realm VARCHAR(256) not null, seuil_pc INT not null, seuil_pc_guilde INT not null, taux_pc INT not null, ilevel INT not null, extension INT not null DEFAULT 3, primary key (id));
