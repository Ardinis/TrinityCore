...
('756', 'La bataille commence !', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Битва началась'),
('757', '%s à défendu la forteresse !', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s успешно защитил(а) крепость!'),
('758', '%s à prit la forteresse !', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s захватил(а) крепость'),
('759', '%s workshop à été endomagé par %s!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('760', '%s workshop à été détruit par %s!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('761', 'La %s tour à été endomagée !', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s башня повреждена'),
('762', 'La %s tour à été détruite !', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s башня уничтожена!'),
('763', 'La forteresse du joug d hiver est attaquée !', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('766', 'La bataille pour le joug d hiver à commencée.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('767', 'La bataille pour le joug d hiver est terminée.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('768', 'Joug d hiver information: %s controllé. Timer: %s. Temps restant: %s. Nombre de joueurs: (Horde: %u, Alliance: %u)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('771', 'vous êtes passé rang 1: Caporal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Вы достигли Ранга 1: Капрал'),
('772', 'Vous êtes passé rang 2: Premier Lieutenant', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Вы достигли Ранга 2: Лейтенант'),
('780', '30 minutes avant le début de la bataille du joug d\'hiver!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'До битвы на  Озере Ледяных Оков осталось 30 минут!'),
('781', '10 minutes avant la bataille du joug d\'hiver ! Des portails seront mis à disposition à Dalaran avant le début de la bataille.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'До битвы на  Озере Ледяных Оков осталось 10 минут! Портал с Даларана начнет работу во время боя.'),
('782', 'La bataille pour le joug s est arretée ! Pas assez de défensseurs.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Битва за Озеро Ледяных Оков Остановлена. Не хватает защитников. Крепость переходит атакующей  стороне.'),
('783', 'La bataille pour le joug s est arretée ! Pas assez de d\'attaquants.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Битва за Озеро Ледяных Оков Остановлена. Не хватает нападающих. Крепость остается защитникам.');
...
('59096', '571', '5330.65', '2841.98', '410.0', '3.14'),
...
DELETE FROM `creature` WHERE `spawntimesecs`=150 AND `id` IN (31841, 31842);
...
(31841,571,1,1,0,0,5103.13,3462.13,368.568,5.270895,150,0,0,126000,7988,0), -- The Broken Temple
(31841,571,1,1,0,0,5540.13,2898.13,518.568,5.270895,150,0,0,126000,7988,0), -- The Broken Temple
(31842,571,1,1,0,0,5540.13,2898.13,518.568,5.270895,150,0,0,126000,7988,0), -- The Broken Temple
(31842,571,1,1,0,0,5103.13,3462.13,368.568,5.270895,150,0,0,126000,7988,0); -- The Broken Temple


UPDATE creature_template SET unit_flags=16388,speed_walk=0,speed_run=0 WHERE entry=28366;

DELETE FROM gameobject WHERE id = 193596;
