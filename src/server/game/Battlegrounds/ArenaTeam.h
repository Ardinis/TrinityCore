...
class ArenaTeam
{
    public:
		...
		int32  GetRatingModWon(uint32 ownRating, uint32 ownMMRRating, uint32 opponentRating, bool won);
        ...
        void   MemberWon(Player* player, uint32 Own_MMRating, uint32 againstMatchmakerRating, int32 MatchmakerRatingChange);
