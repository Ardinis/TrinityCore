...
void WorldSession::HandleMovementOpcodes(WorldPacket & recv_data)
{
    ...
    if (plMover)
    {
		...
		/*		if (vehMover)
		  {
		    std::cout << "zone detected : " << plMover->GetZoneId() << std::endl;
		  if (plMover->GetZoneId() == 210)
		    allowed_delta *= 4;
		    }*/
                    ...
                    #endif
		    {
		      ...
		      std::string str = "";
		      str = "|cFFFFFC00[AC]|cFF00FFFF[|cFF60FF00" + std::string(plMover->GetName())
			+ "|cFF00FFFF] Possible speed hack | teleportation !";
