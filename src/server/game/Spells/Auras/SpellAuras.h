...
class Aura
{
    ...
    public:
        ...
        void SetAuraStateTimer(int32 timer, uint8 effmask) { m_auraStateTimer = timer; m_auraStateTimerMask = effmask;}
    ...
    protected:
        ...
        int32 m_auraStateTimer;
        uint8 m_auraStateTimerMask;
