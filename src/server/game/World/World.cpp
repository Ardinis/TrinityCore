...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_BATTLEGROUND_STORE_STATISTICS_ENABLE]      = ConfigMgr::GetBoolDefault("Battleground.StoreStatistics.Enable", true);
...
void World::InitPacketThrottling()
{
  ...
  opcodePerSecond[CMSG_CONTROLLER_EJECT_PASSENGER] = 1;
  opcodePerSecond[CMSG_EQUIPMENT_SET_SAVE] = 1;
  opcodePerSecond[CMSG_DELETEEQUIPMENT_SET] = 1;
  opcodePerSecond[CMSG_REMOVE_GLYPH] = 1;
  ...
  opcodePerSecond[CMSG_GROUP_ACCEPT] = 1;
  opcodePerSecond[CMSG_GROUP_DECLINE] = 1;
  ...
  opcodePerSecond[CMSG_LEAVE_BATTLEFIELD] = 1;
  ...
  opcodePerSecond[CMSG_GUILD_LEADER] = 1;
  opcodePerSecond[CMSG_GUILD_MOTD] = 1;
  opcodePerSecond[CMSG_GUILD_SET_PUBLIC_NOTE] = 1;
  opcodePerSecond[CMSG_GUILD_SET_OFFICER_NOTE] = 1;
  opcodePerSecond[CMSG_GUILD_RANK] = 1;
