...
public:
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokens::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            const_cast<CreatureTemplate*>(cInfo)->speed_swim = fields[21].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->speed_fly = fields[22].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->scale = fields[23].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->rank = fields[24].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->mindmg = fields[25].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->maxdmg = fields[26].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->dmgschool = fields[27].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->attackpower = fields[28].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->dmg_multiplier = fields[29].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->baseattacktime = fields[30].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->rangeattacktime = fields[31].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->unit_class = fields[32].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->unit_flags = fields[33].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->dynamicflags = fields[34].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->family = fields[35].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->trainer_type = fields[36].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->trainer_spell = fields[37].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->trainer_class = fields[38].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->trainer_race = fields[39].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->minrangedmg = fields[40].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->maxrangedmg = fields[41].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->rangedattackpower = fields[42].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->type = fields[43].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->type_flags = fields[44].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->lootid = fields[45].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->pickpocketLootId = fields[46].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->SkinLootId = fields[47].GetUInt32();

            for (uint8 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; ++i)
            {
                const_cast<CreatureTemplate*>(cInfo)->resistance[i] = fields[48 + i -1].GetUInt32();
            }

            const_cast<CreatureTemplate*>(cInfo)->spells[0] = fields[54].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[1] = fields[55].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[2] = fields[56].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[3] = fields[57].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[4] = fields[58].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[5] = fields[59].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[6] = fields[60].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->spells[7] = fields[61].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->PetSpellDataId = fields[62].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->VehicleId = fields[63].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->mingold = fields[64].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->maxgold = fields[65].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->AIName = fields[66].GetString();
            const_cast<CreatureTemplate*>(cInfo)->MovementType = fields[67].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->InhabitType = fields[68].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->HoverHeight = fields[69].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->ModHealth = fields[70].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->ModMana = fields[71].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->ModArmor = fields[72].GetFloat();
            const_cast<CreatureTemplate*>(cInfo)->RacialLeader = fields[73].GetBool();
            const_cast<CreatureTemplate*>(cInfo)->questItems[0] = fields[74].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->questItems[1] = fields[75].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->questItems[2] = fields[76].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->questItems[3] = fields[77].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->questItems[4] = fields[78].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->questItems[5] = fields[79].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->movementId = fields[80].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->RegenHealth = fields[81].GetBool();
            const_cast<CreatureTemplate*>(cInfo)->equipmentId = fields[82].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->MechanicImmuneMask = fields[83].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->flags_extra = fields[84].GetUInt32();
            const_cast<CreatureTemplate*>(cInfo)->ScriptID = sObjectMgr->GetScriptId(fields[85].GetCString());
