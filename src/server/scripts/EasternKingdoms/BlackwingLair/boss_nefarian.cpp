...
public:
    ...
    class spell_nefarian_controled_mage_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_mage_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_warrior_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_warrior_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_warrior_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_druid_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_druid_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_druid_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_priest_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_priest_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
/*
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId`=13 AND `SourceEntry` = 23415;
...
(13,0,23415,0,0,18,0,1,11583,0,0,'', '');
*/
//    SPELL_PALADIN               = 23418,     //syphon blessing
...
public:
    ...
    class spell_nefarian_controled_paladin_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_paladin_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_shaman_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_shaman_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_warlock_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_warlock_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_hunter_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_hunter_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_nefarian_controled_rogue_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnUnitTargetSelect += SpellUnitTargetFn(spell_nefarian_controled_rogue_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
