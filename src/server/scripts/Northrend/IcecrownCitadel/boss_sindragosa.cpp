...
public:
    ...
    struct boss_sindragosaAI : public BossAI
    {
        ...
        void EnterCombat(Unit* victim)
        {
            ...
            me->ResetLootMode();
            //            if (instance->GetData(DATA_ZONE_SUPPORT_BUFF_STATE) >= REQUIRED_ZONE_SUPPORT_BUFF_VALUE_HM)
            //    me->AddLootMode(2);
            ...
            case POINT_AIR_PHASE:
                    ...
                    return;
                {
                    ...
                    if (threatlist.size())
                    {
                        ...
                        {
                            DoScriptText(EMOTE_WARN_FROZEN_ORB, me, *it);
        ...
        void UpdateAI(uint32 const diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_AIR_MOVEMENT_FAR:
                    ...
                    break;
                case EVENT_ICE_TOMB:
                    DoAction(ACTION_ASPHYXIATION_CHECK);
                ...
                case EVENT_LAND_GROUND:
                    ...
                    me->GetMotionMaster()->MoveLand(POINT_LAND_GROUND, SindragosaLandPos, 8.247422f);
                    break;
...
public:
    ...
    class spell_sindragosa_s_fury_SpellScript : public SpellScript
    {
        ...
        void SelectDest()
        {
            if (Position* dest = const_cast<WorldLocation*>(GetTargetDest()))
            {
...
public:
    ...
    class spell_sindragosa_icy_grip_SpellScript : public SpellScript
    {
        ...
        {
            PreventHitDefaultEffect(effIndex);
            if (!GetHitUnit()->HasAura(SPELL_FROST_BEACON) && GetCaster()->getVictim() != GetHitUnit())
