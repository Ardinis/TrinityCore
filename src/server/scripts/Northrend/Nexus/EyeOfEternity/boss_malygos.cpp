...
class spell_arcane_overload : public SpellScriptLoader
{
    public:
        ...
        class spell_arcane_overload_SpellScript : public SpellScript
        {
            ...
            void ResizeEffectRadiusTargetChecker(std::list<Unit*>& targets)
            {
            ...
            {
                // OnUnitTargetSelect
                OnUnitTargetSelect += SpellUnitTargetFn(spell_arcane_overload_SpellScript::ResizeEffectRadiusTargetChecker, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
...
class spell_scion_of_eternity_arcane_barrage : public SpellScriptLoader
{
    public:
        ...
        class spell_scion_of_eternity_arcane_barrage_SpellScript : public SpellScript
        {
            ...
            void FilterMeleeHoverDiskPassangers(std::list<Unit*>& targets)
            {
                if (targets.empty())
                    return;
                ...
                std::list<Unit*> playersWithoutDisk;
                ...
                if (!targets.empty())
                {
                    ...
                    if (Unit* filteredTarget = targets.front())
                        if (malygos)
            ...
            void Register()
            {
                OnUnitTargetSelect += SpellUnitTargetFn(spell_scion_of_eternity_arcane_barrage_SpellScript::FilterMeleeHoverDiskPassangers, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
...
class spell_malygos_surge_of_power_warning_selector_25 : public SpellScriptLoader
{
    public:
        ...
        class spell_malygos_surge_of_power_warning_selector_25_SpellScript : public SpellScript
        {
            ...
            void SendThreeTargets(std::list<Unit*>& targets)
            {
                ...
                std::list<Unit*> selectedTargets = targets;
                ...
                for (std::list<Unit*>::const_iterator itr = selectedTargets.begin(); itr != selectedTargets.end(); ++itr)
                {
            ...
            void Register()
            {
                OnUnitTargetSelect += SpellUnitTargetFn(spell_malygos_surge_of_power_warning_selector_25_SpellScript::SendThreeTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
...
class spell_malygos_surge_of_power_25 : public SpellScriptLoader
{
    public:
        ...
        class spell_malygos_surge_of_power_25_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnUnitTargetSelect += SpellUnitTargetFn(spell_malygos_surge_of_power_25_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
