...
enum MimironTramCooldown
{
    MIMIRON_TRAM_COOLDOWN	= 75000,
};
...
enum UlduarTypes
{
    ...
    // Leviathan HardMode flags
    DATA_LEVIATHAN_HARD_MODE, 
    DATA_LEVIATHAN_TOWER_STORM,
    DATA_LEVIATHAN_TOWER_FROST, 
    DATA_LEVIATHAN_TOWER_FLAME,
    DATA_LEVIATHAN_TOWER_LIFE,
};
