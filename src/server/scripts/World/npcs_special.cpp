...
#define EMOTE_SUBMERGE             "Ahune bas en retraite. Ses defenses s'affaiblissent."
#define EMOTE_EMERGE_SOON          "Ahune va bientot refaire surface."
#define GOSSIP_STONE_ITEM          "Celui qui activera la pierre invoquera le Seigneur Ahune !"
    ...
    public:
        ...
        struct npc_frostlord_ahuneAI : public Scripted_NoMovementAI
        {
            ...
            void Reset()
            {
                ...
                me->SummonGameObject(GO_ICE_STONE, -64.9921f, -157.543f, -4.1762f, 0, 0, 0, 0, 0, 0);
            }
