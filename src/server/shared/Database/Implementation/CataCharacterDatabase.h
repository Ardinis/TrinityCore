...
#ifndef _CATACHARACTERDATABASE_H
#define _CATACHARACTERDATABASE_H

#include "DatabaseWorkerPool.h"
#include "MySQLConnection.h"

class CataCharacterDatabaseConnection : public MySQLConnection
{
    public:
        //- Constructors for sync and async connections
        CataCharacterDatabaseConnection(MySQLConnectionInfo& connInfo) : MySQLConnection(connInfo) {}
        CataCharacterDatabaseConnection(ACE_Activation_Queue* q, MySQLConnectionInfo& connInfo) : MySQLConnection(q, connInfo) {}

        //- Loads database type specific prepared statements
        void DoPrepareStatements();
};

typedef DatabaseWorkerPool<CataCharacterDatabaseConnection> CataCharacterDatabaseWorkerPool;

enum CataCharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_INS_CATACHARACTER,

    /*    CHAR_INS_ARENA_SEASON_CHAR_REWARD,
    ...
    CHAR_SEL_CHARACTER_CUSTOMTRANSMO,
    CHAR_SEL_MAILITEMS,
    ...
    CHAR_SEL_PVESTATS_CONFIG,
    CHAR_INS_PVESTATS_GUILD,
    ...
    //Systeme recup Oxy
    CHAR_GET_RECUP_STATUS,
    CHAR_GET_RECUP_MODE,
    CHAR_GET_RECUP_VALIDATION,
    CHAR_GET_RECUP_DATA,
    CHAR_GET_RECUP_ILEVEL,
    CHAR_GET_RECUP_GUILD_STATUS,
    CHAR_SET_RECUP_STATUS,
    CHAR_SET_RECUP_GUILD_STATUS,
    CHAR_GET_RECUP_LIST,
    CHAR_MAX_RECUP_LIST,
    CHAR_GET_RECUP_REMPLACE,
    CHAR_GET_RECUP_GUILD_ITEMS,
    CHAR_GET_RECUP_GUILD_GOLD,*/

    MAX_CATACHARACTERDATABASE_STATEMENTS,
};
